...
public class PuzzleBoardView extends View {
    ...
    public void shuffle() {
        if (animation == null && puzzleBoard != null) {
            ...
            puzzleBoard=puzzleBoard.neighbours().get(random.next.Int(size));
            puzzleBoard.reset();
            invalidate();
        }
    }
    ...
    public void solve() {
        PriorityQueue<PuzzleBoard>boardPriorityQueue=new PriorityQueue<>(1, new Comparator<PuzzleBoard>() {
            @Override
        ...
        boardPriorityQueue.add(current);

        while(!boardPriorityQueue.isEmpty()){
            PuzzleBoard bestState=boardPriorityQueue.poll();
            if(bestState.resolved()){
                ...
                boardPriorityQueue.addAll(bestState.neighbours());
            }
        }
    }
}
